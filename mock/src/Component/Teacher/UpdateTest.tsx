...
import { getTestById, updateTestbyid } from "../../API/classAPI";
...
function UpdateTest() {
    ...
    useEffect(() => {
        getTestById(test_id, (data: any) => {
            // eslint-disable-next-line react-hooks/exhaustive-deps
            cauhoi = data;
            setcauhoisave(data);
            setCauhoipreview(JSON.parse(data[0].noi_dung));
        });
    }, [test_id]);
            ...
            >
                {({ errors, touched, values }) => (
                    <Form>
                        ...
                        <button type="submit">Sửa bài kiểm tra</button>
                    </Form>
                )}
            </Formik>
